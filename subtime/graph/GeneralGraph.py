...
from subtime.graph.Graph import Graph
...
class GeneralGraph(Graph, ABC):
    ...
    # custom add, add a bi-directed edge <-> to the graph
    ...
    # Custom change of a faster remove edges
        # Removes the given edge from the graph.
    def remove_edge_only(self, edge: Edge):
        node1 = edge.get_node1()
        node2 = edge.get_node2()
    ...
    # Returns true if this is a subtime lag model.
