...
from subtime.utils.ProxyTest.estimator import margEstimate,condEstimate
...
class ProxyTest():
    ...
    def _est_Q(self,):
        ...
        self.Q0_hat = np.kron(np.eye(self.levely - 1), self.Q_hat)
    ...
    def test(self,):
        ...
        #打印检查
        # print(f"Q_hat shape: {self.Q_hat.shape}")
        # print(f"Q0_hat shape: {self.Q0_hat.shape}")
        # print(f"sigma_hat shape: {self.sigma_hat.shape}")
        # print(f"q_hat shape: {self.q_hat.shape}")
        # print(f"I shape: {I.shape}")
        # print(f"sigma_halfinv shape: {sigma_halfinv.shape}")
